...
4. **-Woverflow (переполнение при вычислении константы)**

* Строка: 115
* Код: `int overflow_const = 2147483647 + 1;`
* Текст предупреждения: `warning: integer overflow in expression of type 'int' results in '-2147483648' [-Woverflow]`
* Объяснение: Сложение констант привело к переполнению 32‑битного `int`.
